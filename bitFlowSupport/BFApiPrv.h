...
BFDLL BFRC			BFCAPI BFPollingThreadCreate(Bd Board,	BFU32 Interrupt, BFU32 PollRegisterID, BFU32 PollPause, BFU32 RegisterMax, BFPollInfoPtr pPollHandle);
BFDLL BFRC			BFCAPI BFPollingThreadThreadDestroy(Bd Board, BFPollInfoPtr pPollHandle);
...
BFDLL BFRC			BFCAPI BFCamListInsert(Bd Board, PBFCNF pCam, PBFCHAR ConfigMode, PBFCHAR FileName);
BFDLL BFRC			BFCAPI BFCamListRemove(Bd Board, PBFCNF pCam);
...
// Pixel router
BFDLL BFRC			BFCAPI PixelRouterCreate(BFU32 Width, BFU32 ZoneX, BFU32 TapX, BFU32 ExtX, BFS32 Start[10], BFS32 Step[10], BFU32 Options, void **hRouteResults);
BFDLL BFRC			BFCAPI PixelRouterCreateEx(BFU32 NumTaps, BFS32 Start[10], BFS32 Step[10], void **hRouteResults) ;
BFDLL void			BFCAPI PixelRouterDelete(void *hRouteResults);
BFDLL BFRC			BFCAPI StartStepArrayBuild(BFU32 Width, BFU32 ZoneX, BFU32 TapX, BFU32 ExtX, BFS32 Start[10], BFS32 Step[10]);
BFDLL BFRC			BFCAPI PixelRouterToBoard(Bd hBoard, void *hRouteResults, BFU32 CLMode, BFU32 CLChannels); 
