...
typedef enum _BIRC_Enum
{
	...
	BI_ERROR_HIGHFRAMERATE,			// Error error starting/stopping high frame rate polling 
	...
	BI_ERROR_TOO_MANY_FRAMES,		// The current hardware does not support sequences of this many frames
    ...
    // Ci method errors.
    BI_CIERROR_CISYSBRDENUM,        // An error occured in the CiSysBrdEnum function.
    BI_CIERROR_CISYSBOARDFINDSWCONNECTOR,   // An error occured in the CiSysBoardFindSWConnector function.
    BI_CIERROR_CIBRDOPEN,           // An error occured in the CiBrdOpen function.

    BI_CIERROR_CIAQFRAMESIZE,       // An error occured in the CiAqFrameSize function.
    BI_CIERROR_CIAQROISET,          // An error occured in the CiAqROISet function.
    BI_CIERROR_CICONEXTRIGCONNECT,  // An error occured in the CiConExTrigConnect function.
    BI_CIERROR_CICONEXPOSURECONTROLSET, // An error occured in the CiConExposureControlSet function.
    BI_CIERROR_CICONEXPOSURECONTROLGET, // An error occured in the CiConExposureControlGet function.

    BI_CIERROR_CICAMMODESENUM,      // An error occured in the CiCamModesEnum function.
    BI_CIERROR_CICAMMODEGET,        // An error occured in the CiCamModeGet function.
    BI_CIERROR_CICAMMODESET,        // An error occured in the CiCamModeSet function.

    // BF method errors.
    BI_BFERROR_BFCXPREADREG,        // An error occured in the BFCXPReadReg function.
    BI_BFERROR_BFCXPWRITEREG,       // An error occured in the BFCXPWriteReg function.
    BI_BFERROR_BFCXPREADDATA,       // An error occured in the BFCXPReadData function.
    BI_BFERROR_BFCXPWRITEDATA,      // An error occured in the BFCXPWriteData function.
    BI_BFERROR_BFREGNAME,           // An error occured in the BFRegName function.
    BI_BFERROR_BFREGPOKE,           // An error occured in the BFRegPoke function.
