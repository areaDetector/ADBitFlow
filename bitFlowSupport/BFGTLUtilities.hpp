 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::ValueNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::IntegerNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::BooleanNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::CommandNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::FloatNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::StringNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::RegisterNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::CategoryNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::EnumerationNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::EnumEntryNodeBase
 */
 ...
 * \extends BFGTLUtilities::PRIVATE_IMP::PortNodeBase
 */
...
namespace BFGTLUtilities
{
    ...
    public:
        ...
        // if necessary.
        BFVOID open (const BFU32 brdNum, const BFU32 options = 0);
        ...
        // Open a BFGTL Camera Device for the given board number and handle. This will generally be
        // faster than opening the other open methods. The Device must be closed prior to closing the
        // board handle.Closes the current Device first, if necessary.
        BFVOID open (const BFU32 brdNum, Bd hBoard, const BFU32 options = 0);
        ...
        // Determine whether or not the named node exists.
