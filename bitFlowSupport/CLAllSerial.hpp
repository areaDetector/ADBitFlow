...
namespace CLComm
{
    ...
    public:
        ...
        std::string serialRead (const CLUINT32 NumBytesToRead, const CLUINT32 SerialTimeout) const;
        ...
        // Reads data from the serial device. Equivalent to the other serialRead methods, but
        // returns available data even on timeout, in which case it does not throw an exception.
        std::string serialReadEx (const CLUINT32 NumBytesToRead, const CLUINT32 SerialTimeout, BFBOOL *const TimeoutExceeded = nullptr) const;

        // Reads data from the serial device, returning the number of bytes read. Equivalent to the
        // other serialRead methods, but returns available data even on timeout, in which case it
        // does not throw an exception.
        CLUINT32 serialReadEx (std::vector<CLINT8> &Buffer, const CLUINT32 ReadLen, const CLUINT32 SerialTimeout, BFBOOL *const TimeoutExceeded = nullptr) const;
        CLUINT32 serialReadEx (CLINT8 *const Buffer, const CLUINT32 BufferSize, const CLUINT32 SerialTimeout, BFBOOL *const TimeoutExceeded = nullptr) const;
