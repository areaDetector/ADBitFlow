...
#define BFSysNoGenTLInit                    0x00004000  // Don't use GenTL camera control during board initialization.
#define BFSysNoIOReset						0x00008000  // Do not reset I/O outputs before setting them as per configuration file
// Camera open options.
...
// Trigger Selectsion
// these do not correspond to the register values
typedef enum _BFTrigTypes
{
	...
	BFTrigTSCT0,
	BFTrigVFG0TSCT0, 
	BFTrigBoxInTTL0,	// vvvv note these must be in sequential order vvvv
	BFTrigBoxInTTL1,
	BFTrigBoxInTTL2,
	BFTrigBoxInTTL3,
	BFTrigBoxInTTL4,
	...
	BFTrigBoxIn24V1,
	BFTrigBoxIn24V2,
	BFTrigBoxIn24V3,// ^^^^ note these must be in sequential order ^^^^
...
typedef enum _BFEncTypes
{
	...
	BFEncTSCT0,
	BFEncVFG0TSCT0,
	BFEncBoxInTTL0,	// vvvv note these must be in sequential order vvvv
	BFEncBoxInTTL1,
	BFEncBoxInTTL2,
	BFEncBoxInTTL3,
	BFEncBoxInTTL4,
	...
	BFEncBoxIn24V1,
	BFEncBoxIn24V2,
	BFEncBoxIn24V3,// ^^^^ note these must be in sequential order ^^^^
	BFEncUnknown = 0xffff
} BFEncTypes;
...
// BitBox output sources
typedef enum _BFBBXTypes
{
	BFBBXLow = 0,
	BFBBXHi,
	BFBBXVFG0CC1,
...
// BFBrdInqModel
	...
	BFBrdValModelAxn2xB,
	BFBrdValModelAxn4xB,
	BFBrdValModelAonCXP1,
	BFBrdValModelClxCXP1,
	BFBrdValModelClxCXP2,
	BFBrdValModelClxCXP4,
...
enum _CAMINQ
{
	...
	BFCamInqDoCXPDiscovery,
	BFCamInqBitDepthOptions,
	BFCamInqCamLineWidth,
	BFCamInqCamLineWidthUse,
	BFCamInqCamFrameHeight,
	BFCamInqCamFrameHeightUse,
	BFCamInqAqOffWhenClosing,
	BFCamInqMaxCXPVersion,
	BFCamInqRequiresTLParamsLocked,
};

enum BFCamUseOptions
{
	BFCamUseDefault,
	BFCamUsePixelRouter,
	BFCamUsePixelRouterAndAE,
};
...
// Gen2 tap formatter optoins
#define		FormatterNormal		0	// No special processing
#define		FormatterRGBSwap	1 	// Swap R & B
#define		FormatterManual		2	// use the manual tap format
#define		FormatterIgnore		4	// Format ignores bitdepth, format assumes 8-bit pixels 

/*
* this are family and interrupt specific interrupt metadata queue size 
* The unit here a number of entries
* This is multiplied by the pBFInfo->MetadataSize[IntType] value to get
* the total queue size in bytes
*/
#define BFIntTypeEODMetadataQueueSizeGN2	1000
#define BFIntTypeEventRcvdMetadataQueueSize	100
