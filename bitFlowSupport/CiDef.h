...
#define CISYS_TYPE_GN2					FF_GN2				// Cyton, etc.
...
#define CiCamInqPackedPixels			BFCamInqPackedPixels
...
#define CiDMAPhysical					BFDMAPhysical
...
// These are used by CiMMMIterate and should not change (need to be the same for all versions)
#define CI_BAD_CONFIG	1
#define CI_BAD_INDEX	2
