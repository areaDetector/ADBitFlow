...
typedef Bd BFGTLUtilBd;
typedef BFRC BFTLUtilRC;
typedef BFBOOL BFGTLUtilBool;
typedef BFU8 BFGTLUtilU8;
typedef BFU32 BFGTLUtilU32;
typedef PBFU32 PBFGTLUtilU32;
typedef BFS64 BFGTLUtilS64;
typedef BFDOUBLE BFGTLUtilDouble;
typedef BFSIZET BFGTLUtilSizeT;
typedef PBFSIZET PBFGTLUtilSizeT;
typedef BFCHAR BFGTLUtilChar;
typedef BFVOID BFGTLUtilVoid;

#   define BFGTLUTIL_IMPORT_EXPORT_ERR BFDLL BFRC BFCAPI
#   define BFGTLUTIL_IMPORT_EXPORT_BOOL BFDLL BFBOOL BFCAPI
...
typedef tCIp BFGTLUtilBd;
typedef tCIRC BFTLUtilRC;
typedef tCIU8 BFGTLUtilBool;
typedef tCIU8 BFGTLUtilU8;
typedef tCIU32 BFGTLUtilU32;
typedef BFGTLUtilU32* PBFGTLUtilU32;
typedef signed long long BFGTLUtilS64;
typedef double BFGTLUtilDouble;
typedef size_t BFGTLUtilSizeT;
typedef BFGTLUtilSizeT* PBFGTLUtilSizeT;
typedef char BFGTLUtilChar;
typedef void BFGTLUtilVoid;

#   if __GNUC__ >= 4
#       define BFGTLUTIL_IMPORT_EXPORT_ERR __attribute__ ((visibility ("default"))) BFTLUtilRC
#       define BFGTLUTIL_IMPORT_EXPORT_BOOL __attribute__ ((visibility ("default"))) BFGTLUtilBool
#   else
#       define BFGTLUTIL_IMPORT_EXPORT_ERR BFTLUtilRC
#       define BFGTLUTIL_IMPORT_EXPORT_BOOL BFGTLUtilBool
#   endif

#else
#   error Platform implementation undefined.
#endif
...
typedef enum BFGTLVisibilityEnum
{
...
typedef enum BFGTLNodeFieldEnum
{
    ...
    BFGTL_NODE_DESCRIPTION      = 0x0005,
        ...
        // [Access:RO;TYPE:BFGTL_TYPE_UINT32] The node's BFGTLVisibility.
    BFGTL_NODE_VISIBILITY       = 0x0006,
