 ...
 *  -# BFGTLUtilities - A simplified interface to Gen&lt;i&gt;Cam devices. The matching Gen&lt;i&gt;Cam reference
 *   implementation must be installed to use this library, which may be downloaded from <a href="http://www.emva.org/">emva.org</a>.
 */
