...
BFDLL BFU64			BFCAPI BFOnBoardRate(Bd Board);
...
// Interrupt Metadata Queue
BFDLL BFRC			BFCAPI BFIntMetadataQueueGetInAddr(Bd Board, BFU32 IntType, PBFU32 pInAddr, PBFU32 pCount, PBFU32 pPacketSize, PBFU32 pQueueSize);
BFDLL BFRC			BFCAPI BFIntMetadataQueueGetPacket(Bd Board, BFU32 IntType, BFU32 Addr, PBFU32 pPacket, BFU32 PacketSize, PBFU32 pCount);
...
BFDLL BFBOOL		BFCAPI BFIsAxnBase(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxnII(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsCtnII(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxn1xE(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxn2xE(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxn1xB(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxn2xB(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAxn4xB(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAon(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAonII(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsAonCXP1(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsClx(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsClxCXP1(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsClxCXP2(Bd Board);
BFDLL BFBOOL		BFCAPI BFIsClxCXP4(Bd Board);

BFDLL BFBOOL		BFCAPI BFIsSynthetic(Bd Board);
BFDLL BFBOOL		BFCAPI BFHasSerialPort(Bd Board);
...
BFDLL BFRC			BFCAPI BFCXPResync(Bd Board, BFU32 Link, BFU32 RequestedLinkSpeed, PBFU32 pNumLinks, BFU32 Timeout);
...
BFDLL BFRC			BFCAPI BFCXPFindMasterLink(Bd Board, PBFU32 pLink);
BFDLL BFBOOL		BFCAPI BFCXPIsLinkAlive(Bd Board, BFU32 Link);
BFDLL BFRC			BFCAPI BFCXPVersionNegotiate(Bd Board, PBFU32 LinkList, BFU32 NumLinks, BFU32 MaxCXPVersion);
BFDLL BFRC			BFCAPI BFCXPReadEventPacketFIFO(Bd Board, BFU32 Link, EventPacketPtr pEventPacket);
BFDLL BFRC			BFCAPI BFCXPReadEventPacket(Bd Board,  BFSignalTimeInfoPtr pTimeInfo, EventPacketPtr pEventPacket);
BFDLL BFRC			BFCAPI BFCXPParseEventPacket(Bd Board, BFU32 EventIndex, EventPacketPtr pEventPacket, EventMessagePtr pEventMessage, PBFBOOL pNoMoreMessages);
BFDLL BFRC			BFCAPI BFCXPGetHostTime(Bd Board, BFU32 Link, PBFU64 pHostTime);
BFDLL BFRC			BFCAPI BFCXPGetLastHeartbeat(Bd Board, BFU32 Link, CXPHeartbeatPtr pHeartbeat);
...
BFDLL BFRC          BFCAPI BFOutputDebugStringEx(BFU32 Type, BFU32 Source, PBFCHAR Title, PBFCHAR Text);
