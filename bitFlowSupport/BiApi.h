...
BFDLL BFRC		BFCAPI BiSeqAqSetupPitch(Bd Board, PBIBA pBufArray, BFU32 Pitch, BFU32 Options);
...
BFDLL BFRC		BFCAPI BiCircAqSetupPitch(Bd Board, PBIBA pBufArray, BFU32 Pitch, BFU32 ErrorMode, BFU32 Options);
...
BFDLL BFRC BFCAPI BiCallBackAdd(Bd Board, PBIBA pBufArray, BiCallBackFuncPtr CallBackFunc, PBFVOID pUserData);
