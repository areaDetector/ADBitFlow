...
Gn2DLL Gn2RC	Gn2CAPI Gn2CamUpdateParams(Gn2 Board);

Gn2DLL Gn2RC	Gn2CAPI Gn2PixelRouterSet(Gn2 Board, BFU32 Format, BFU32 CameraLineWidth, BFU32 PixDepth, BFU32 BitDepthOptions);

Gn2DLL Gn2RC	Gn2CAPI Gn2CurrentConfigModeSet(Gn2 Board, PBFCHAR ModeName);
Gn2DLL Gn2RC	Gn2CAPI Gn2CamHandleBFMLCommands(Gn2 Board, BFU32 Type);
...
Gn2DLL Gn2RC	Gn2CAPI Gn2TSSequenceSet(Bd Board, BFU32 Sequencer, TSListPtr TSList, BFU32 PreTrigCT0, BFU32 PreTrigCT1, BFU32 PreTrigCT2, BFU32 PreTrigCT3, BFU32 TriggerSrc);
Gn2DLL Gn2RC	Gn2CAPI Gn2TSSequenceGet(Bd Board, BFU32 Sequencer, TSListPtr *TSList, PBFU32 pPreTrigCT0, PBFU32 pPreTrigCT1, PBFU32 pPreTrigCT2, PBFU32 pPreTrigCT3, PBFU32 pTriggerSrc);
Gn2DLL Gn2RC	Gn2CAPI Gn2TSSequenceFree(Bd Board, TSListPtr TSList);
Gn2DLL Gn2RC	Gn2CAPI Gn2ConCamLineWidthSet(Gn2 Board, BFU32 CamLineWidth);
Gn2DLL Gn2RC	Gn2CAPI Gn2ConProgAqSize(Gn2 Board, BFU32 XOffset, BFU32 YOffset, BFU32 XSize, BFU32 YSize);

Gn2DLL Gn2RC	Gn2CAPI Gn2ConEncoderInputSet(Gn2 Board, BFU32 Encoder, BFU32 EncSelect, BFU32 EncPolarity);
Gn2DLL Gn2RC	Gn2CAPI Gn2ConEncoderInputGet(Gn2 Board, BFU32 Encoder, PBFU32 EncSelect, PBFU32 EncPolarity);
Gn2DLL Gn2RC	Gn2CAPI Gn2ConTriggerInputSet(Gn2 Board, BFU32 TrigSelect, BFU32 TrigPolarity);
Gn2DLL Gn2RC	Gn2CAPI Gn2ConTriggerInputGet(Gn2 Board, PBFU32 TrigSelect, PBFU32 TrigPolarity);
// Quad Tables
