...
// Creator:     Bob Sheff
//
// Copyright (C) 1993-2014 by BitFlow, Inc.  All Rights Reserved.
//
// Description:
//
...
// Version defines used to build version resources.
	...
	#define BF_LEGAL_COPYRIGHT_STRING		"Copyright © 2008-2019 LinX Corporation\0"
	...
	#define BF_LEGAL_COPYRIGHT_STRING		"Copyright © 1996-2019 BitFlow Inc\0"
	#define BF_COMPANY_STRING				"BitFlow, Inc.\0"
	#define BF_INTERNAL_NAME				"BitFlow.sys\0"

#endif

#define BF_PRODUCT_VERSION_NUMBERS		6, 5, 0, 0
#define BF_PRODUCT_VERSION_STRING		"6.5.0.0\0"

#define BF_FILE_VERSION_NUMBERS			6, 5, 0, 0
#define BF_FILE_VERSION_STRING			"6.5.0.0\0"
