...
BFDLL  BFS32	BFC BFstrcmp(const BFCHAR *String1, const BFCHAR *String2);
BFDLL  BFS32	BFC BFstricmp(const BFCHAR *String1, const BFCHAR *String2);
BFDLL  BFS32	BFC BFstrncmp(const BFCHAR *String1, const BFCHAR *String2, BFSIZET Len);
BFDLL  BFS32	BFC BFstrnicmp(const BFCHAR *String1, const BFCHAR *String2, BFSIZET Len);
#ifdef __cplusplus
}
#endif
