...
BFDLL BFRC		BFCAPI CiBrdCamGetMMM(Bd Board,PBFCHAR Make, BFU32 MakeStrSize, PBFCHAR Model, BFU32 ModelStrSize, PBFCHAR Mode, BFU32 ModeStrSize);
BFDLL BFRC		BFCAPI CiFindLiveVFGs(VFGListPtr *pVFGList);
BFDLL BFRC		BFCAPI CiFreeVFGList(VFGListPtr pVFGList);
...
BFDLL BFRC		BFCAPI  CiCamModeSet(Bd Board, PBFCNF pCam, PBFCHAR ModeName);
BFDLL BFRC		BFCAPI	CiCamModeGet(Bd Board, PBFCHAR ModeName, BFSIZET ModeNameSize);
BFDLL BFRC		BFCAPI	CiCurrentConfigModeSet(Bd Board, PBFCHAR ModeName);
BFDLL BFRC		BFCAPI  CiCamModesEnum(Bd Board, PBFCNF pCam, BFU32 Index, PBFCHAR ModeName, BFU32 ModeNameSize, PBFCHAR ModeComment, BFU32 ModeCommentSize);
BFDLL BFRC		BFCAPI	CiCamUpdateParams(Bd Board);
...
BFDLL BFRC		BFCAPI CiCallBackAdd(Bd Board, BFU32 SignalType, BFCallBackFuncPtr CallBackFunc, PBFVOID pUserData);
...
BFDLL BFRC		BFCAPI CiConNumFramesSet(Bd Board, BFU32 NumFrames);
...
BFDLL BFRC		BFCAPI CiConTriggerInputGet(Bd Board, PBFU32 TrigSelect, PBFU32 TrigPolarity);
BFDLL BFRC		BFCAPI CiConTriggerInputSet(Bd Board, BFU32 TrigSelect, BFU32 TrigPolarity);
BFDLL BFRC		BFCAPI CiConEncoderInputGet(Bd Board, BFU32 Encoder, PBFU32 EncSelect, PBFU32 EncPolarity);
BFDLL BFRC		BFCAPI CiConEncoderInputSet(Bd Board, BFU32 Encoder, BFU32 EncSelect, BFU32 EncPolarity);
BFDLL BFRC		BFCAPI CiConIsCameraReady(Bd Board, PBFBOOL pReady);
BFDLL BFRC		BFCAPI CiConCamLineWidthSet(Bd Board, BFU32 CamLineWidth);
...
BFDLL BFRC		BFCAPI CiMMMIterate(BFU32 Index, PBFCHAR Make, BFU32 MakeStrSize, PBFCHAR Model, BFU32 ModelStrSize, PBFCHAR Mode, BFU32 ModeStrSize, PBFBOOL pCLModel);
