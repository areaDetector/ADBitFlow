...
typedef enum _FF_BITFLOW_DEVICES
{
	...
	FF_GN2				= 0x00000080,			// Gen 2 family.
	...
	FF_DIF				= 0x00200000,			// Special Dif version of the root family.
} FF_BITFLOW_DEVICES;
...
#define FF_BITFLOW_SUPPORTS		(FF_ROADRUNNER | FF_R64 | FF_GN2)
#define FF_BITFLOW_MODERN		(FF_ROADRUNNER | FF_R64 | FF_GN2)
...
#define FF_R64_DIF				(FF_R64 | FF_DIF)
...
#define FF_GN2_CXP				(FF_GN2 | FF_CXP)
#define FF_GN2_CL				(FF_GN2 | FF_CAMERALINK)
#define FF_GN2_DRIVER			(FF_GN2 | FF_DRIVER)
...
typedef enum _BF_Families
{
	...
	FF_NeonDif				=	FF_R64_DIF,
	FF_CytonCXP				=	FF_GN2_CXP,
	FF_AxionCL				=	FF_GN2_CL,
} BF_Families;
...
#define BF_PCI_NEO_DIF			0x4001			// Neon Dif Device ID
#define BF_PCI_ALT_AN			0x5000			// Alta-AN Device ID
#define BF_PCI_ALT_CO			0x6000			// Alta-CO Device ID
#define BF_PCI_CYTON_CXP4		0x7000			// Cyton CXP4 Device ID
#define BF_PCI_CYTON_CXP2		0x7002			// Cyton CXP2 Device ID
#define BF_PCI_AXION_1XE		0x801E			// Axion 1xE Device ID
#define BF_PCI_AXION_2XE		0x802E			// Axion 2xE Device ID
#define BF_PCI_AXION_1XB		0x801B			// Axion 1xB Device ID
#define BF_PCI_AXION_2XB		0x802B			// Axion 2xB Device ID
#define BF_PCI_AXION_4XB		0x804B			// Axion 4xB Device ID
#define BF_PCI_AON_CXP1			0xA001			// Aon CXP1 Device ID
#define BF_PCI_CLAXON_CXP1_E	0xB01E			// Claxon CXP1 Ecqologic (looks like an Aon)
#define BF_PCI_CLAXON_CXP2_E	0xB02E			// Claxon CXP2 Ecqologic
#define BF_PCI_CLAXON_CXP4_E	0xB04E			// Claxon CXP4 Ecqologic
#define BF_PCI_CLAXON_CXP2_T2	0xB06E			// Claxon CXP2 2 Transmit Ecqologic
#define BF_PCI_CLAXON_CXP4_T4	0xB08E			// Claxon CXP4 4 Transmit Ecqologic
#define BF_PCI_CLAXON_CXP2_M	0xB02A			// Claxon CXP2 MAXOM
#define BF_PCI_CLAXON_CXP4_M	0xB04A			// Claxon CXP4 MACOM
#define BF_PCI_CLAXON_FXP2		0xB02F			// Claxon CXP2 Fiber
#define BF_PCI_CLAXON_FXP4		0xB04F			// Claxon CXP4 Fiber
...
#define DID_BF_MODERN_MASK			0xffff			// Device Id bits used to identify BitFlow families.
...
typedef struct _VFORec
{
	...
	BFBOOL			SerialPort;					// True if the board has a serial port
	BFBOOL			PMC;						// True for a PMC BitFlow device.
	BFBOOL			PLDAEngine;					// Set to true if the board has a PLDA Engine
	BFBOOL			StreamSyncEngine;				// Set to true if the board has the Streaming DMA engine
	...
	BFBOOL			FWCompatible;				// CXP only - Board firmware is compatible with this SDK version

	BFU32			PCIeLinkWidth;				// PCIe Link Width (negotiated)
	BFU32			PCIeLinkSpeed;				// PCIe Link Speed (negotiated)
