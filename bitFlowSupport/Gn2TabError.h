...
typedef enum _Gn2RC_Enum
{
	...
	GN2_TS_UNKNOWN,					// Unknown Timing Sequencer
	GN2_TOO_MANY_LINKS,				// BFML flie requires more links than board has
	GN2_UNKNOWN_MODE,				// Request for mode that is not known
	GN2_NO_AUTO_INFO,				// BFML file in auto mode but no info in camera
	GN2_BASE_ONLY_AXN,				// Axion is based only and camera is medium/full/80-bit
	GN2_ERROR_END
} Gn2RC_Enum;
